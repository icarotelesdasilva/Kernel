...
grub_end_symbol="_end"

# Build environment
grub_target_cc='gcc'
grub_target_cc_version='gcc (Debian 14.2.0-19) 14.2.0'
...
grub_target_cppflags=' -Wall -W  -DGRUB_MACHINE_PCBIOS=1 -DGRUB_MACHINE=I386_PC -m32 -nostdinc -isystem /usr/lib/gcc/x86_64-linux-gnu/14/include -I$(top_srcdir)/include -I$(top_builddir)/include'
...
grub_target_objconf=''
grub_target_obj2elf=''
grub_target_img_base_ldopt='-Wl,--defsym=_grub_text_base'
grub_target_img_ldflags='@TARGET_IMG_BASE_LDFLAGS@'

# Version
grub_version="2.15"
grub_package="grub"
grub_package_string="GRUB 2.15"
grub_package_version="2.15"
